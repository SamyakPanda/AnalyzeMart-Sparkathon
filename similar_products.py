...
for category, subcategories in industries.items():
    for subcategory, products in subcategories.items():
        for product, price in products.items():
            # take all products in subgroup except the current product
            similar_products[product] = [p for p in products if p != product]
